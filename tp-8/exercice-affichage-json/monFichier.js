...
function initialiserDonnees() {
        ...
        document.querySelector('#titre').innerHTML = data.polluant+" "+data.unite;
        document.querySelector('#annee').innerHTML = data.annee;
       for (var i = 0; i < data.pays.length; i++ ) {
            var value = data.pays[i].nom+" "+data.pays[i].valeur+" "+data.pays[i].pourcentage+" "+data.pays[i].code;
           document.querySelector('#listePays').innerHTML += "<br> -  : " + value;
         }
